...
Meteor.startup ->
  ...
  if Meteor.isServer
    ...
    copyRecursiveSync = (src, dest)->
      ...
      stats = exists and fs.lstatSync src
    ...
    if !fs.existsSync i18n.storageDir
      copyRecursiveSync 'initialData', i18n.storageDir
  ...
  if Meteor.isClient
    ...
    Meteor.subscribe "i18n", ->
      i18n.isReady = true
      i18n.init Meteor.get('language') unless i18n.isStarted
